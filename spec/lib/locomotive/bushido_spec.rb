...
describe 'Bushido support' do
  ...
  context '#loaded' do
    ...
    it 'does not add instance methods to Site' do
      Site.new.should_not respond_to(:add_bushido_domains)
      Site.new.should_not respond_to(:remove_bushido_domains)
      Site.should_not respond_to(:create_first_one_with_bushido)
    end
  ...
  context '#enabled' do
    ...
    it 'adds a method to automatically create a site with Bushido settings' do
      ...
      Site.should respond_to(:create_first_one_with_bushido)
    end
